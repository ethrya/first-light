...
- Include the source name and URL for each story.
- For source_url, use the actual URL you found in search results. If you're unsure of the exact URL, leave it as an empty string.
